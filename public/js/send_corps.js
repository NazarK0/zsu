...
const backgroundInitDeleteFormsAction = (selector) => {
  ...
  backgroundDeleteFormList.forEach((form) => {
    form.onsubmit = async (e) => {
      ...
      const response = await fetch(`/corps/bg/delete/${del_id}`, {
        method: 'POST',
      });
...
const signInitDeleteFormsAction = (selector) => {
  ...
  signDeleteFormList.forEach((form) => {
    form.onsubmit = async (e) => {
      ...
      const response = await fetch(`/corps/sign/delete/${del_id}`, {
        method: 'POST',
      });
...
backgroundAddForm.onsubmit = async (e) => {
  ...
  const response = await fetch('/corps/bg/add', {
    method: 'POST',
    body: formData,
  });
...
signAddForm.onsubmit = async (e) => {
  ...
  const response = await fetch('/corps/sign/add', {
    method: 'POST',
    body: formData,
  });
